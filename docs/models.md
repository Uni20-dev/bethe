...
| `haldane-shastry` | Spin-1/2 inverse-chord-square exchange on a ring, [Haldane](../CITATIONS.md#haldane-1988) and [Shastry](../CITATIONS.md#shastry-1988) | [Implemented](haldane-shastry.md): exact motif energies, momenta, Yangian dimensions, spin-sector minima and a budgeted SU(2)-decomposition library. Full motif scans have an explicit budget; spin-content CLI export, wavefunctions and correlations remain future work |

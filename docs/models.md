...
| `xyz` | Zero-field spin-1/2 XYZ chain, PBC finite-size spectrum | [Numerical foundation implemented](xyz.md); no spectrum solver yet | Large; regular roots next |
...
| `xyz` | Zero-field spin-1/2 XYZ / eight-vertex family, [Baxter](../CITATIONS.md#baxter-1973) and [Zhang–Klümper–Popkov](../CITATIONS.md#zhang-klumper-popkov-2024) | [Native-precision theta functions, coupling and energy normalization implemented](xyz.md); root selection, singular solutions, and spectrum validation remain. Sz is not generally conserved |

...
| `lee-yang` | Massive non-unitary M(2,5) on a periodic circle, [Bajnok–el Deeb–Pearce](../CITATIONS.md#bajnok-el-deeb-pearce-2015) | [Source conventions and independent oracle](lee-yang.md) established; native source-free ground-state TBA is next. Bulk-subtracted energy and c_eff=2/5 must be distinguished from c=-22/5. Excited states require additional source terms |

...
| `xyz` | Zero-field spin-1/2 XYZ chain, PBC finite-size spectrum | [Even-chain regular ground branch implemented](xyz.md); library only | Ground frontend next; excited spectrum remains large |
...
| `xyz` | Zero-field spin-1/2 XYZ / eight-vertex family, [Baxter](../CITATIONS.md#baxter-1973) and [Zhang–Klümper–Popkov](../CITATIONS.md#zhang-klumper-popkov-2024) | [Native-precision even-chain regular ground solver implemented](xyz.md), checked against small-chain exact energies and XXZ limits; frontend, singular solutions and excited spectrum remain. Sz is not generally conserved |

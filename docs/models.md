...
| `lee-yang` | Massive non-unitary M(2,5) on a periodic circle, [Bajnok–el Deeb–Pearce](../CITATIONS.md#bajnok-el-deeb-pearce-2015) | [Native source-free ground-state TBA library](lee-yang.md) implemented with independent oracle checks; frontend is next. Bulk-subtracted energy and c_eff=2/5 must be distinguished from c=-22/5. Excited states require additional source terms |

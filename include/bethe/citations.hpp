...
inline constexpr std::array<Link, 3> links_8{{
...
inline constexpr std::array<Link, 3> links_50{{
...
inline constexpr std::array<Reference, 53> references{{
  ...
  {"bajnok-2020", "Zoltán Bajnok, Etienne Granet, Jesper Lykke Jacobsen, and Rafael I. Nepomechie", "On Generalized Q-systems", "JHEP 03 (2020) 177", 2020, links_7},
  {"popkov-2021", "Vladislav Popkov, Xin Zhang, and Andreas Klümper", "Phantom Bethe excitations and spin helix eigenstates in integrable periodic and open spin chains", "Phys. Rev. B 104, L081410", 2021, links_8},
  {"kozlowski-2017", "Karol K. Kozlowski", "On condensation properties of Bethe roots associated with the XXZ chain", "arXiv:1508.05741v2", 2017, links_9},
  {"lieb-wu-2003", "Elliott H. Lieb and F. Y. Wu", "The one-dimensional Hubbard model: A reminiscence", "Physica A 321, 1-27", 2003, links_10},
  {"rylands-2022", "Colin Rylands, Bruno Bertini, and Pasquale Calabrese", "Integrable quenches in the Hubbard model", "J. Stat. Mech. 2022, 103103", 2022, links_11},
  {"deguchi-yue-1997", "Tetsuo Deguchi and Ruihong Yue", "Exact solutions of 1-D Hubbard model with open boundary conditions and the conformal dimensions under boundary magnetic fields", "arXiv:cond-mat/9704138", 1997, links_12},
  {"lieb-mattis-1962", "Elliott Lieb and Daniel Mattis", "Theory of Ferromagnetism and the Ordering of Electronic Energy Levels", "Phys. Rev. 125, 164-172", 1962, links_13},
  {"lieb-liniger-1963", "Elliott H. Lieb and Werner Liniger", "Exact Analysis of an Interacting Bose Gas. I. The General Solution and the Ground State", "Phys. Rev. 130, 1605", 1963, links_14},
  {"lieb-1963-excitations", "Elliott H. Lieb", "Exact Analysis of an Interacting Bose Gas. II. The Excitation Spectrum", "Phys. Rev. 130, 1616", 1963, links_15},
  {"gaudin-1971", "M. Gaudin", "Boundary Energy of a Bose Gas in One Dimension", "Phys. Rev. A 4, 386", 1971, links_16},
  {"gaudin-1967", "M. Gaudin", "Un système à une dimension de fermions en interaction", "Phys. Lett. A 24, 55-56", 1967, links_17},
  {"yang-1967", "C. N. Yang", "Some Exact Results for the Many-Body Problem in One Dimension with Repulsive Delta-Function Interaction", "Phys. Rev. Lett. 19, 1312", 1967, links_18},
  {"yang-1968", "C. N. Yang", "S Matrix for the One-Dimensional N-Body Problem with Repulsive or Attractive delta-Function Interaction", "Phys. Rev. 168, 1920", 1968, links_19},
  {"sutherland-1975", "Bill Sutherland", "Model for a multicomponent quantum system", "Phys. Rev. B 12, 3795", 1975, links_20},
  {"essler-korepin-1992", "Fabian H. L. Essler and Vladimir E. Korepin", "Higher conservation laws and algebraic Bethe Ansätze for the supersymmetric t-J model", "Phys. Rev. B 46, 9147", 1992, links_21},
  {"babujian-1982", "H. M. Babujian", "Exact solution of the one-dimensional isotropic Heisenberg chain with arbitrary spins S", "Phys. Lett. A 90, 479-482", 1982, links_22},
  {"vlijm-caux-2014", "Rogier Vlijm and Jean-Sébastien Caux", "Computation of dynamical correlation functions of the spin-1 Babujan-Takhtajan chain", "J. Stat. Mech. 2014, P05009", 2014, links_23},
  {"dukelsky-2004", "J. Dukelsky, S. Pittel, and G. Sierra", "Colloquium: Exactly solvable Richardson-Gaudin models for many-body quantum systems", "Rev. Mod. Phys. 76, 643-662", 2004, links_24},
  {"faribault-2011", "Alexandre Faribault, Omar El Araby, Christoph Sträter, and Vladimir Gritsev", "Gaudin models solver based on the correspondence between Bethe ansatz and ordinary differential equations", "Phys. Rev. B 83, 235124", 2011, links_25},
  {"faribault-schuricht-2013", "Alexandre Faribault and Dirk Schuricht", "Spin decoherence due to a randomly fluctuating spin bath", "Phys. Rev. B 88, 085323", 2013, links_26},
  {"sutherland-1968", "Bill Sutherland", "Further Results for the Many-Body Problem in One Dimension", "Phys. Rev. Lett. 20, 98-100", 1968, links_27},
  {"lee-2011", "J. Y. Lee, X. W. Guan, and M. T. Batchelor", "Yang-Yang method for the thermodynamics of one-dimensional multi-component interacting fermions", "J. Phys. A: Math. Theor. 44, 165002", 2011, links_28},
  {"imambekov-demler-2006", "Adilet Imambekov and Eugene Demler", "Exactly solvable case of a one-dimensional Bose-Fermi mixture", "Phys. Rev. A 73, 021602(R)", 2006, links_29},
  {"wang-1999", "Yupeng Wang", "Exact solution of a spin-ladder model", "Phys. Rev. B 60, 9236", 1999, links_30},
  {"hakobyan-2004", "Tigran Hakobyan", "The ordering of energy levels for SU(n) symmetric antiferromagnetic chains", "Nucl. Phys. B 699, 575-594", 2004, links_31},
  {"bogoliubov-1997", "N. M. Bogoliubov, A. G. Izergin, and N. A. Kitanine", "Correlation functions for a strongly correlated boson system", "arXiv:solv-int/9710002", 1997, links_32},
  {"baxter-1973", "R. J. Baxter", "Eight-vertex model in lattice statistics and one-dimensional anisotropic Heisenberg chain. III. Eigenvectors of the transfer matrix and Hamiltonian", "Ann. Phys. 76, 48-71", 1973, links_33},
  {"haldane-1988", "F. D. M. Haldane", "Exact Jastrow-Gutzwiller resonating-valence-bond ground state of the spin-1/2 antiferromagnetic Heisenberg chain with 1/r^2 exchange", "Phys. Rev. Lett. 60, 635", 1988, links_34},
  {"shastry-1988", "B. Sriram Shastry", "Exact solution of an S=1/2 Heisenberg antiferromagnetic chain with long-ranged interactions", "Phys. Rev. Lett. 60, 639", 1988, links_35},
  {"sutherland-1971", "Bill Sutherland", "Exact Results for a Quantum Many-Body Problem in One Dimension", "Phys. Rev. A 4, 2019", 1971, links_36},
  {"andrei-1980", "N. Andrei", "Diagonalization of the Kondo Hamiltonian", "Phys. Rev. Lett. 45, 379", 1980, links_37},
  {"destri-de-vega-1992", "C. Destri and H. J. de Vega", "New thermodynamic Bethe ansatz equations without strings", "Phys. Rev. Lett. 69, 2313-2317", 1992, links_38},
  {"gwa-spohn-1992", "Leh-Hun Gwa and Herbert Spohn", "Bethe solution for the dynamical-scaling exponent of the noisy Burgers equation", "Phys. Rev. A 46, 844", 1992, links_39},
  {"yang-yang-1966", "C. N. Yang and C. P. Yang", "One-Dimensional Chain of Anisotropic Spin-Spin Interactions. I. Proof of Bethe's Hypothesis for Ground State in a Finite System", "Phys. Rev. 150, 321", 1966, links_40},
  {"shastry-sutherland-1990", "B. Sriram Shastry and Bill Sutherland", "Twisted boundary conditions and effective mass in Heisenberg-Ising and Hubbard rings", "Phys. Rev. Lett. 65, 243", 1990, links_41},
  {"de-vega-gonzalez-ruiz-1994", "H. J. de Vega and A. González-Ruiz", "Boundary K-matrices for the XYZ, XXZ and XXX spin chains", "J. Phys. A: Math. Gen. 27, 6129-6138", 1994, links_42},
  {"essler-de-klerk-2023", "F. H. L. Essler and A. J. J. M. de Klerk", "Statistics of matrix elements of local operators in integrable models", "arXiv:2307.12410v1", 2023, links_43},
  {"yang-yang-1969", "C. N. Yang and C. P. Yang", "Thermodynamics of a One-Dimensional System of Bosons with Repulsive Delta-Function Interaction", "J. Math. Phys. 10, 1115", 1969, links_44},
  {"doikou-nepomechie-1998", "Anastasia Doikou and Rafael I. Nepomechie", "Bulk and Boundary S Matrices for the SU(N) Chain", "Nucl. Phys. B 521, 547-572", 1998, links_45},
  {"oelkers-2006", "N. Oelkers, M. T. Batchelor, M. Bortz, and X.-W. Guan", "Bethe Ansatz study of one-dimensional Bose and Fermi gases with periodic and hard wall boundary conditions", "J. Phys. A 39, 1073-1098", 2006, links_46},
  {"grijalva-2019", "Sebastian Grijalva, Jacopo De Nardis, and Veronique Terras", "Open XXZ chain and boundary modes at zero temperature", "SciPost Phys. 7, 023", 2019, links_47},
  {"dugave-2015", "M. Dugave, F. Göhmann, K. K. Kozlowski, and J. Suzuki", "On form-factor expansions for the XXZ chain in the massive regime", "J. Stat. Mech. (2015) P05037", 2015, links_48},
  {"caux-xxz-coordinate", "Jean-Sébastien Caux", "The Bethe Ansatz: coordinate wavefunctions and periodic XXZ equations", "Online notes", 0, links_49},
  {"korepin-2009", "Vladimir E. Korepin", "Norm of Bethe Wave Function as a Determinant", "arXiv:0911.1881 (historical account of the 1982 norm formula)", 2009, links_50},
  {"bini-robol-2013", "Dario A. Bini and Leonardo Robol", "Solving secular and polynomial equations: a multiprecision algorithm", "Author manuscript, May 10, 2013", 2013, links_51},
  {"cameron-graillat-2022", "Thomas R. Cameron and Stef Graillat", "On a compensated Ehrlich-Aberth method for the accurate computation of all polynomial roots", "Electronic Transactions on Numerical Analysis 55, 401-423", 2022, links_52},
}};
...
inline constexpr std::array<Use, 5> uses_xxz_pbc{{
  ...
  {&references[9], "Even-ring negative-anisotropy sector ground states: Eqs. (0.4), (0.7), with Pauli exchange divided by four. We use rank-subtracted equations scaled near Delta=-1; the reference explicitly assumes even length and does not justify odd-ring ground-state selection."},
  {&references[48], "Massive periodic XXZ Hamiltonian and trigonometric Bethe equations, Eqs. (1.1)-(1.2), with zero twist and field; Pauli exchange is divided by four. Used for Delta>1 sector ground states, not form factors, strings or excitations."},
...
inline constexpr std::array<Use, 2> uses_xxz_obc{{
  ...
  {&references[47], "Massive open XXZ boundary root and finite-size deviation, Sec. 4.3.2, specialized to zero boundary fields; used for Delta>1 ground states, not boundary correlations or excitation scans."},
}};
inline constexpr std::array<Use, 2> uses_hubbard_pbc{{
  {&references[10], "Lieb-Wu ground-state equations and quantum-number parity, Eqs. (1), (11), (14)-(18); t=1 and unshifted U*n_up*n_down."},
  {&references[11], "Full particle-hole and partial particle-hole (Shiba) transformations, Sec. II, Eqs. (4)-(7); used for sector mappings, not quench dynamics."},
}};
inline constexpr std::array<Use, 3> uses_hubbard_obc{{
  {&references[12], "Free-end Hubbard energy and nested reflection equations, Eqs. (2.5)-(2.8), (3.1)-(3.2), with all boundary potentials zero; t=1 and unshifted interaction."},
  {&references[13], "Spin ordering for the nearest-neighbour open chain: the sector minimum has S=|Sz|. No periodic-shell spin-branch selection is required."},
  {&references[11], "Bipartite particle-hole and Shiba transformations, Sec. II; used for physical-to-auxiliary sector mappings, not quench dynamics."},
}};
inline constexpr std::array<Use, 3> uses_lieb_liniger_pbc{{
  {&references[14], "Repulsive Bose gas on a ring, H=-sum d_j^2+2c sum delta, and its ground state; c>0."},
  {&references[15], "Excited-state background; we solve finite-volume states in explicit label windows, not a thermodynamic dispersion calculation."},
  {&references[43], "Explicit normalization and finite-ring equations, Eqs. (4), (24)-(27); root-density equation (32)-(33) used for validation, not a thermodynamics API. No matrix elements are implemented."},
}};
inline constexpr std::array<Use, 2> uses_su3_pbc{{
  {&references[20], "Original multicomponent permutation-chain solution; the implementation selects only the fundamental SU(3) periodic balanced ground state."},
  {&references[45], "Nested equations and energy, Eqs. (2.17)-(2.19), logarithmic labels (2.24)-(2.29), and the filled-sea singlet in Sec. 2.3. Our H=sum P gives E=2*E_paper+L. No strings, S matrices or boundary fields are implemented."},
}};
...
inline constexpr std::array<Use, 2> uses_sun_fermions_pbc{{
  {&references[27], "Original multicomponent delta-gas solution. We implement equal-mass repulsive fermions on a periodic ring, not arbitrary mixtures or statistics."},
  {&references[28], "Nested finite-size Bethe equations (2)-(3), with c'=c/2, and logarithmic signs from (13)-(19). Our Hamiltonian is -sum d_j^2+2c sum delta with c>=0 and no Zeeman term. Only the centered all-odd occupied-population ground branch is implemented; no strings, TBA or attraction."},
}};
inline constexpr std::array<Use, 2> uses_ladder_pbc{{
  {&references[30], "Permutation-form ladder Hamiltonian (2), rung basis (3), chemical-potential form (4), and three nested rational equations (5). We use spin-1/2 operators, leg coefficient 1, four-spin coefficient 4, and J_r=2*J in (2)/(4), restoring E=E_perm-L/4+J_r*(L/4-N_s). Only zero-field periodic ground states and singlet-count sector minima are implemented."},
  {&references[31], "SU(n) multiplets, Young diagrams and weight spaces. The periodic energy-ordering theorem has a row-parity restriction; we do not assume each population's own highest weight is lowest. Compatible dominant multiplets and displaced packed real seas are compared, not the full excited-state spectrum."},
}};
inline constexpr std::array<Use, 3> uses_gaudin_yang_pbc{{
  ...
  {&references[46], "Hamiltonian and periodic fermion equations (1), (2), (7), (8), (25); even N, odd minority population as in Sec. 5. Weak and strong limits (12), (15)-(16) provide checks. Hard walls, attraction and excitations are not implemented."},
}};

enum class Tool { xxx_pbc, xxx_obc, xxz_pbc, xxz_obc, hubbard_pbc, hubbard_obc, lieb_liniger_pbc, su3_pbc, tj_pbc, tb_pbc, richardson, central_spin, sun_fermions_pbc, ladder_pbc, gaudin_yang_pbc };

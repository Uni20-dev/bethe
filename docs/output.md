...
| `bethe-biquadratic-obc` | `states` | real modes: `quantum_numbers`; Q-system: `reference`, `q_coefficients`; two-string singlet: `reference`, `string`; ferro analytic modes: `reference`; numerical `roots` with `--roots` |

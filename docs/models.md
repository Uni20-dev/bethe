...
| `q-boson` | Integrable q-boson hopping/phase model, PBC at fixed particle number | [Ground-state library implemented](q-boson.md); frontend and excitations next | First library slice complete |
...
| `q-boson` | Deformed boson hopping and its phase-model limit, [Bogoliubov–Izergin–Kitanine](../CITATIONS.md#bogoliubov-1997) and [Pozsgay](../CITATIONS.md#pozsgay-2014-q-boson) | [Fixed-N PBC ground-state library implemented](q-boson.md), with occupation-basis checks, free/phase limits and continuum scaling; frontend and excited-state labels remain. Not the standard Bose–Hubbard chain |

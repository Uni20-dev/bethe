...
| `lieb-liniger` | Continuum contact-interacting bosons | Implemented (limited): [repulsive PBC](lieb-liniger.md) and [hard walls](lieb-liniger-open.md), ground states, explicit labels, bounded excitation scans; [bulk ground state and type-I/type-II curves](lieb-liniger-thermo.md); [grand-canonical finite-T library](lieb-liniger-thermal.md) | Attraction, canonical finite-T inversion and thermal frontend, form factors |
...
cutoff checks. Fixed-density inversion and a thermal frontend are next;
...
and a thermal frontend remain follow-ups. This model-specific layer is not a

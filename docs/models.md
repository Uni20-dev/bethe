...
| `asep` | Periodic asymmetric exclusion process, relaxation spectrum | [TASEP relaxation-gap library/frontend implemented](tasep.md), arbitrary filling | Partial asymmetry remains |
...
| `asep` | Periodic asymmetric simple exclusion process, [Gwa–Spohn](../CITATIONS.md#gwa-spohn-1992) and [Golinelli–Mallick](../CITATIONS.md#golinelli-mallick-2005) | [TASEP relaxation-gap library/frontend implemented](tasep.md) at arbitrary filling, with separate complex eigenvalue and positive decay gap; partial asymmetry remains. These are rates, not Hermitian energies |

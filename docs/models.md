...
| `sine-gordon` | Integrable quantum field theory, finite-volume ground energy via nonlinear integral equations | [Bulk-subtracted vacuum library implemented](sine-gordon.md) | Frontend and excited states remain |
...
| `sine-gordon` | Continuum sine-Gordon theory, [Destri–de Vega](../CITATIONS.md#destri-de-vega-1992), [Rutkevich](../CITATIONS.md#rutkevich-2020) | [Native complex kernel and finite-volume vacuum library](sine-gordon.md) implemented; frontend and excited states remain. Soliton-mass/coupling and bulk-subtraction conventions specified. Large-volume Bethe–Yang quantization alone omits finite-volume corrections |

...
| `sine-gordon` | Integrable quantum field theory, finite-volume ground energy via nonlinear integral equations | [Complex-kernel foundation implemented](sine-gordon.md) | Vacuum NLIE and frontend remain |
...
| `sine-gordon` | Continuum sine-Gordon theory, [Destri–de Vega](../CITATIONS.md#destri-de-vega-1992), [Rutkevich](../CITATIONS.md#rutkevich-2020) | [Native complex scattering kernel and vacuum-solver plan](sine-gordon.md) implemented; finite-volume ground-state scaling function remains. Soliton-mass/coupling and bulk-subtraction conventions specified. Large-volume Bethe–Yang quantization alone omits finite-volume corrections |

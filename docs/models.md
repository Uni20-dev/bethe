...
| `kondo` | The integrable continuum single-impurity Kondo problem | [Zero-temperature scaling-limit target specified](kondo.md); independent reference oracle available | Native impurity energy-change/magnetization evaluator next; no finite-band absolute-energy claim |
...
| `kondo` | Integrable continuum single-impurity Kondo Hamiltonian, [Andrei](../CITATIONS.md#andrei-1980), response conventions in [Barcza et al.](../CITATIONS.md#barcza-2020) | [Equation-level target and independent oracle](kondo.md): zero-temperature, spin-1/2 single-channel scaling-limit impurity energy change in a uniform field. Native evaluator remains to implement. Not a generic finite-band Anderson impurity or Kondo lattice |

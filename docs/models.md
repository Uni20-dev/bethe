...
| `kondo` | The integrable continuum single-impurity Kondo problem | [Native zero-temperature scaling-limit response library](kondo.md) | Frontend next; no finite-band absolute-energy claim |
...
| `kondo` | Integrable continuum single-impurity Kondo Hamiltonian, [Andrei](../CITATIONS.md#andrei-1980), response conventions in [Barcza et al.](../CITATIONS.md#barcza-2020) | [Native response library and independent oracle](kondo.md): zero-temperature, spin-1/2 single-channel scaling-limit impurity energy change and magnetization in a uniform field. Frontend remains. Not a generic finite-band Anderson impurity or Kondo lattice |
